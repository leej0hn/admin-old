 ...
 */
package io.communet.admin.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new io.communet.admin.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new io.communet.admin.modules.sys.entity.User(null, userId)))){
